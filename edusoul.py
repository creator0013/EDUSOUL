            ...
            if input_path.lower().endswith((".mp4", ".avi", ".mov", ".mkv")):
                ...
                raise ValueError(
                    f"Unsupported file format: {
                        os.path.basename(input_path)}. Please provide a video or image file."
                )
        ...
        if invalid_numbers:
            (
                messagebox.showinfo(
                    ...
                    f"{
                    len(invalid_numbers)} numbers could not be validated:\n{
                    ', '.join(
                        list(invalid_numbers)[
                            :10])}...\n"
                    f"and {
                        len(invalid_numbers) -
                        10} more.",
                ...
                if len(invalid_numbers) > 10
                    ...
                    "Process Completed",
                    f"Contact numbers processed and saved to {excel_output_path}.\n\n"
                    f"These numbers could not be validated: {
